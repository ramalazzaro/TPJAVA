...
public class Estadisticas {
    ...
    public SortedSet<Publicacion> getListaPublicacionesPorFecha() {
        return listaPublicacionesPorFecha;
    }

    public SortedSet<Publicacion> getLista5PublicacionesMasLikes() {
    ...
    public HashMap<Integer, Integer> LikesPorAño(SortedSet<Publicacion> listaPublicaciones) {
        ...
        for (Integer clave : MapCantLikesAño.keySet()) {
            System.out.println(clave + " " + MapCantLikesAño.get(clave));
        }
    ...
    public void cantPublicacionesDeCadaTipo(SortedSet<Publicacion> listaPublicaciones) {
        ...
        for (Publicacion publicacion : listaPublicaciones) {
            ...
            else if ("Video".equals(publicacion.getClass().getName()))
                MapCant.put("Video", MapCant.get("Video") + 1);
            else if ("Audio".equals(publicacion.getClass().getName()))
                MapCant.put("Audio", MapCant.get("Audio") + 1);
            else
                MapCant.put("Texto", MapCant.get("Texto") + 1);
        }
        for (String clave : MapCant.keySet()) {
            System.out.println(clave + " " + MapCant.get(clave));
        }
    }
    ...
    public void publicacionesConMasLikes(SortedSet<Publicacion> listaPublicaciones) {
        ...
        // Iterator<Publicacion> publicacionLikesIterator =
        // lista5PublicacionesMasLikes.iterator();
     ...
     * HashMap<Integer,Integer> MapLikesPorAño =
