...
public class ReportesAlbumes {
    ...
    /**
     * Valida si la fecha mínima es válida en comparación con la fecha de la última publicación.
     *
    ...
    /**
     * Valida si la fecha máxima es válida en comparación con la fecha de la primera publicación.
     *
     * @param estadisticas Las estadísticas del perfil de Instagram.
